              ...
              <div
                className={
                  type === items.id
                    ...
                    : 'flex justify-center items-center flex-col py-3 border-t-2 border-white py-3'
                }
              >
                {items.icon}
      ...
      <div className='hidden lg:flex gap-14 container px-20 my-8 mx-auto'>
        {allTypes.map((items) => (
          <Link to={`/${items.id}`} key={items.id}>
            ...
            >
              <div
                className={classnames('w-16 h-16 bg-gray-100 rounded-full', {
                  [`bf-${items.activeColor}-100`]: type === items.id,
                })}
              >
                <img
                  src={
